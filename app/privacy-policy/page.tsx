...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      {/* ————————————————— SEO ————————————————— */}
      <Head>
        <title>Privacy Policy | nayastack</title>
        <meta
          name="description"
          content="Read nayastack's privacy policy about data collection, usage, cookies, and user rights."
        />
      </Head>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <article className="space-y-16 text-base sm:text-lg leading-relaxed lg:w-3/4">
            ...
            <section id="contact" className="scroll-mt-28">
              ...
              <p className="mt-2 text-blue-600 font-medium">nayastack8810@gmail.com</p>
            </section>
          </article>
        </div>
      </main>
