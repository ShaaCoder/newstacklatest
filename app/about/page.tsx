            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <Image
                    src={member.image}
                    alt={`${member.name}, ${member.role} at nayastack`}
                    width={200}
                    height={200}
              ...
              {[
                {
                  ...
                  quote: 'nayastack transformed our e-commerce platform, boosting conversions by 40%.',
        ...
        <section className="py-32 bg-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="relative">
              ...
              {[
                { year: '2018', event: 'nayastack Founded', desc: 'Started with a vision to revolutionize digital solutions.' },
